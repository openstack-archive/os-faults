...
from os_faults.api.service import Service
 ...
 * reboot [random|one|single] <service> node[s]
 * reboot <fqdn> node[s]
...
SERVICE_ACTIONS = list_actions(Service)
SERVICE_ACTIONS_PATTERN = '|'.join(SERVICE_ACTIONS)
NODE_ACTIONS = list_actions(NodeCollection)
