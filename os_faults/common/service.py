...
class SystemdService(ServiceAsProcess):
    ...
    **Example configuration:**
    ...
    - **systemd_service** - name of a service
    - **grep** - regexp for grep to find process PID
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.restart_cmd = 'systemctl restart {}'.format(self.systemd_service)
        self.terminate_cmd = 'systemctl stop {}'.format(self.systemd_service)
        self.start_cmd = 'systemctl start {}'.format(self.systemd_service)
