...
class ServiceInSystemdUnit(service.ServiceAsProcess):
    ...
    **Example configuration:**
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.restart_cmd = ("sudo systemctl restart "
                            "devstack@{}.service".format(self.unit_name))

        # stop systemd unit
        self.terminate_cmd = ("sudo systemctl stop "
                              "devstack@{}.service".format(self.unit_name))

        # start systemd unit
        self.start_cmd = ("sudo systemctl start "
                          "devstack@{}.service".format(self.unit_name))

        # enable systemd unit
        self.start_cmd = ("sudo systemctl enable "
                          "devstack@{}.service".format(self.unit_name))

        # disable systemd unit
        self.start_cmd = ("sudo systemctl disable "
                          "devstack@{}.service".format(self.unit_name))
