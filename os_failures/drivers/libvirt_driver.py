...
from os_failures.utils import power_management as pm_utils
...
class LibvirtDriver(power_management.PowerManagement):
    ...
    def poweroff(self, mac_addresses_list):
        pm_utils.run(self._poweroff, mac_addresses_list)

    def poweron(self, mac_addresses_list):
        pm_utils.run(self._poweron, mac_addresses_list)

    def reset(self, mac_addresses_list):
        pm_utils.run(self._reset, mac_addresses_list)
