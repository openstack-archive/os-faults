...
class LibvirtDriver(power_management.PowerManagement):
    ...
    @staticmethod
    def _start(mac_addresses_list, thread_method):
        threads = []
    ...
    def poweroff(self, mac_addresses_list):
        self._start(mac_addresses_list, self._poweroff)

    def poweron(self, mac_addresses_list):
        self._start(mac_addresses_list, self._poweron)

    def reset(self, mac_addresses_list):
        self._start(mac_addresses_list, self._reset)
